Task 0 - Hello Flask
    Files 0-hello_route.py, __init__.py
...
Task 7 - Improve engines
    Files models/engine/file_storage.py, models/engine/db_storage.py, models/state.py
...
Task 8 - List of states
    Files web_flask/7-states_list.py, web_flask/templates/7-states_list.html
...
Task 9 - Cities by states
    Files web_flask/8-cities_by_states.py, web_flask/templates/8-cities_by_states.html
...
Task 10 - States and State
    Files web_flask/9-states.py, web_flask/templates/9-states.html
...
Task 11 - HBNB filters
    Files web_flask/10-hbnb_filters.py, web_flask/templates/10-hbnb_filters.html, web_flask/static/
